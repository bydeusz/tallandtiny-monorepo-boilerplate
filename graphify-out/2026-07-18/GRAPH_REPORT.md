# Graph Report - organisations  (2026-07-18)

## Corpus Check
- 640 files · ~195,188 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3704 nodes · 4459 edges · 397 communities (248 shown, 149 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 23 edges (avg confidence: 0.86)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f16f09fd`
...
6. `UsersService` - 20 edges
7. `useAuth()` - 20 edges
8. `React Native Skills` - 19 edges
9. `UserResponseDto` - 19 edges
10. `OrganisationsService` - 18 edges
...
## Communities (397 total, 149 thin omitted)

### Community 0 - "API Auth Endpoints"
Cohesion: 0.05
Nodes (19): AuthController, AuthService, Harness, CurrentUser, Public(), ActivateDto, AuthTokensResponseDto, ConfirmEmailChangeDto (+11 more)
...
Cohesion: 0.08
Nodes (15): ActivateDto, AuthTokensResponseDto, ChangePasswordDto, ConfirmEmailChangeDto, LoginDto, PaginatedResponseDto, PaginationMetaDto, RefreshTokenDto (+7 more)

### Community 3 - "File Query Hooks"
Cohesion: 0.06
Nodes (32): FileDeleteMutationError, FileDeleteMutationResult, FileGetQueryError, FileGetQueryResult, fileList(), FileListQueryError, FileListQueryResult, fileReplace() (+24 more)
...
Cohesion: 0.09
Nodes (23): UpdateUserDto, UserList200, getUserGetQueryKey(), getUserGetQueryOptions(), getUserListQueryKey(), getUserListQueryOptions(), getUserUpdateMutationOptions(), SecondParameter (+15 more)
...
Cohesion: 0.28
Nodes (7): UploadFileParamsDto, UploadFileQueryDto, FilesController, ALLOWED_UPLOAD_MIME_TYPES, AllowedUploadMimeType, detectMimeFromBuffer(), isAllowedUploadMimeType()
...
Cohesion: 0.22
Nodes (10): clearAccessToken(), getAccessToken(), setAccessToken(), AXIOS_INSTANCE, configureAuthRefresh(), refreshAccessToken(), RefreshConfig, RetriableRequestConfig (+2 more)
...
Cohesion: 0.16
Nodes (14): getAuthGetCurrentUserQueryKey(), getAuthGetCurrentUserQueryOptions(), useAuthGetCurrentUser(), extractErrorMessage(), useToast(), metadata, ALLOWED_TYPES, UpdateAvatar() (+6 more)
...
Cohesion: 0.15
Nodes (13): getAuthRegisterMutationOptions(), getAuthRequestNewPasswordMutationOptions(), useAuthRegister(), useAuthRequestNewPassword(), LoginForm(), LoginFormProps, RegisterConfirmForm(), RegisterForm() (+5 more)
...
Cohesion: 0.12
Nodes (6): TokenUser, JwtPayload, PrismaService, fullUser, UserPublic, assertEmailDomainAllowed()
...
Cohesion: 0.17
Nodes (4): ApiPaginatedResponse(), BaseEntityDto, PaginatedResponseDto, PaginationMetaDto
...
Cohesion: 0.15
Nodes (4): OrganisationMemberGuard, RequestWithMembership, OrganisationOwnerGuard, user
...
Cohesion: 0.15
Nodes (3): OrganisationRow, OrganisationsService, orgRow
...
Cohesion: 0.13
Nodes (5): Roles(), JwtAuthGuard, RequestWithUser, RolesGuard, TestController
...
Cohesion: 0.31
Nodes (6): getAuthActivateMutationOptions(), useAuthActivate(), OtpField(), OtpFieldProps, VerifyEmailForm(), VerifyEmailFormProps
...
Cohesion: 0.09
Nodes (4): PopoverContent(), RadioGroup(), RadioGroupItem(), TooltipContent()
...
## Knowledge Gaps
- **1778 isolated node(s):** `orgRow`, `OrganisationRow`, `Environment`, `LogLevel`, `EnvironmentVariables` (+1773 more)
...
- **Why does `cn()` connect `Community 409` to `Community 416`, `Community 417`, `Community 419`, `Community 421`, `Community 231`, `Community 138`, `Toast Notification System`, `UI Carousel Component`, `Community 240`, `Community 247`, `Community 411`, `API Mail Service`, `Community 413`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `TextField()` connect `UI Carousel Component` to `Community 409`, `Community 174`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `Turborepo Skill` connect `Community 222` to `Community 192`, `Community 167`, `Community 139`, `Community 207`, `Community 149`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **What connects `orgRow`, `OrganisationRow`, `Environment` to the rest of the system?**
